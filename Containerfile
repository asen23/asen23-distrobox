FROM ghcr.io/ublue-os/fedora-toolbox@sha256:40fab1b05f013bee8375438f5fb41ab846e1c05be0a6d95bfc3c4984785e3a57 as base
...
RUN dnf -y upgrade && \
    ...
    dnf -y install dotnet-sdk-6.0 --releasever=40 && \
